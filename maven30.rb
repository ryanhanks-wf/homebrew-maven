class Maven30 < Formula
  ...
  conflicts_with "maven", :because => "maven30 is older versions of this formula"
  conflicts_with "maven31", :because => "maven30 is older versions of this formula"
  conflicts_with "maven32", :because => "maven30 is older versions of this formula"
